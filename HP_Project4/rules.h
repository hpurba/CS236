...
public:
	...
	vector<HeadPredicate> returnHeadPredicateObj();

	vector<Predicates> returnVectorOfPredicates();
};
...
vector<HeadPredicate> Rules::returnHeadPredicateObj() {
	return headPredicateObj;
}

vector<Predicates> Rules::returnVectorOfPredicates() {
